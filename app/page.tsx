            ...
            <div className="w-full max-w-5xl space-y-6">
                <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-2">
                        ...
                        <p className="max-w-2xl text-sm text-muted-foreground md:text-base">
                            Страница собрана как конструктор: можно быстро копировать текст
                            для слайдов, презентаций и описания проекта. Используйте вкладки,
                            аккордионы и переключатели, чтобы просматривать нужные разделы.
                        </p>
                    </div>

                    <Card className="w-full max-w-sm md:w-full">
                        <CardHeader className="pb-3">
                            <CardTitle className="flex items-center justify-between gap-2 text-sm font-medium md:text-base">
                                Режим просмотра
                                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">
                    Компактный
                                    ...
                                    <Switch
                                        ...
                                        aria-label="Переключить компактный режим"
                                    />
                                </div>
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-2">
                            <p className="text-xs text-muted-foreground">
                                В компактном режиме тексты короче и удобнее для быстрых заметок
                                или тезисов на слайды. В обычном — развернутое описание.
                            </p>
                            <Button
                                variant="outline"
                                size="sm"
                ...
                <Tabs defaultValue="structure" className="w-full">
                    <TabsList className="w-full overflow-x-auto">
                        ...
                        <TabsTrigger value="roles">Роли и сценарии</TabsTrigger>
                        <TabsTrigger value="features">Функционал LMS</TabsTrigger>
                        <TabsTrigger value="gamification">Геймификация</TabsTrigger>
                        <TabsTrigger value="slides">Тексты для слайдов</TabsTrigger>
                    </TabsList>
                        ...
                        <Card>
                          ...
                          <span className="font-medium text-foreground">
                            Админ‑панель:
                                                    ...
                                                    управление пользователями, группами, курсами,
                                                    магазином и общими настройками системы.
                                                </li>
                                                <li>
                          <span className="font-medium text-foreground">
                          ...
                          <span className="font-medium text-foreground">
                            Кабинет студента:
                                    ...
                                    <AccordionItem value="tech">
                                        ...
                                        <AccordionContent>
                                            <p className="text-sm text-muted-foreground">
                                                Проект построен как современное React/Next.js приложение
                                                с компонентным подходом, использованием дизайн‑системы
                                                на базе shadcn ui и чётким разделением областей
                                ...
                                <Accordion type="single" collapsible className="w-full">
                                    <AccordionItem value="admin">
                                        ...
                                        <AccordionContent>
                                            ...
                                            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                <li>
                                                    Создание и редактирование пользователей и ролей.
                                                </li>
                                                <li>
                                                    Формирование учебных групп и назначение
                                                    преподавателей.
                                                </li>
                                    ...
                                    <AccordionItem value="student">
                                        ...
                                        <AccordionContent>
                                            ...
                                            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                <li>
                                                    Доступ к курсам, материалам и домашним заданиям.
                                                </li>
                                                <li>Просмотр оценок, рейтинга и истории активности.</li>
                                                <li>
                                                    Отслеживание расписания и дедлайнов в календаре.
                                                </li>
                            ...
                            <CardContent className="space-y-4">
                                <Accordion type="multiple" className="w-full">
                                    <AccordionItem value="courses">
                                        ...
                                        <AccordionContent>
                                            <p className="text-sm text-muted-foreground">
                                                Курсы структурируются на главы и материалы, что
                                                позволяет выстраивать понятный учебный путь. Материалы
                                                могут включать теорию, инструкции, дополнительные
                                                ресурсы и интерактивные элементы.
                                            </p>
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <AccordionItem value="groups">
                                        ...
                                        <AccordionContent>
                                            <p className="text-sm text-muted-foreground">
                                                Группы позволяют объединять студентов по классам,
                                                потокам или курсам. Для каждой группы доступны свои
                                                задания, материалы, достижения и рейтинг.
                                            </p>
                                        </AccordionContent>
                                    </AccordionItem>
                                </Accordion>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <Accordion type="multiple" className="w-full">
                                    <AccordionItem value="coins">
                                        ...
                                        <AccordionContent>
                                            <p className="mb-2 text-sm text-muted-foreground">
                                                Коины — внутренняя валюта системы. Студенты получают их
                                                за разные виды активности и результаты.
                                            </p>
                                            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                <li>
                                    ...
                                    <AccordionItem value="rating">
                                        ...
                                        <AccordionContent>
                                            ...
                                            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                ...
                                                <li>
                                                    Визуальная обратная связь о прогрессе и статусе.
                                                </li>
                                    ...
                                    <AccordionItem value="shop">
                                        ...
                                        <AccordionContent>
                                            ...
                                            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                ...
                                                <li>
                                                    Мотивация возвращаться в систему и быть активным.
                                                </li>
                                            </ul>
                                        </AccordionContent>
                                    </AccordionItem>
